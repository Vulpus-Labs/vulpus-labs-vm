...
/**
 * Provides approximations for some mathematical functions.
 */
public final class Approximate {
    ...
    /**
     * The approximate cosine of an angle measured not in radians but as a unit value between 0.0 (0 degrees) and 1.0
     * (360 degrees).
     *
     * @param x The angle as a unit value.
    ...
    /**
     * The approximate sine of an angle measured not in radians but as a unit value between 0.0 (0 degrees) and 1.0
     * (360 degrees).
     *
     * @param x The angle as a unit value.
