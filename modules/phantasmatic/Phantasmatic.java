package com.vulpuslabs.phantasmatic;
...
import com.vulpuslabs.modules.phantasmatic.*;


//[/user-imports]


public class Phantasmatic extends VoltageModule
//[user-inheritance]
//[/user-inheritance]
{

@SuppressWarnings("this-escape") 
public Phantasmatic( long moduleID, VoltageObjects voltageObjects )
{
   super( moduleID, voltageObjects, "Phantasmatic", ModuleType.ModuleType_Oscillators, 2.6 );

   InitializeControls();


   canBeBypassed = false;
   SetSkin( "f8d90158ff1c4b688640152c8eed953e" );
}
...
void InitializeControls()
{
   ...
   monoDcwModIn.SetPosition( 99, 214 );
   ...
   monoOscillatorOut.SetPosition( 102, 293 );
   ...
   polyDcwModIn.SetPosition( 155, 214 );
   ...
   polyOscillatorOut.SetPosition( 151, 293 );
   ...
   pitch32Toggle.SetPosition( 39, 125 );
   pitch32Toggle.SetSize( 21, 21 );
   pitch32Toggle.SetSkin( "Mini Green" );
   ...
   pitch16Toggle.SetPosition( 61, 125 );
   pitch16Toggle.SetSize( 21, 21 );
   pitch16Toggle.SetSkin( "Mini Green" );
   ...
   pitch4Toggle.SetPosition( 39, 146 );
   pitch4Toggle.SetSize( 21, 21 );
   pitch4Toggle.SetSkin( "Mini Green" );
   ...
   pitch2Toggle.SetPosition( 61, 146 );
   pitch2Toggle.SetSize( 21, 21 );
   pitch2Toggle.SetSkin( "Mini Green" );
   ...
   semitoneKnob.SetPosition( 106, 42 );
   semitoneKnob.SetSize( 27, 27 );
   semitoneKnob.SetSkin( "JP-106 Gray" );
   ...
   centsKnob.SetPosition( 149, 42 );
   centsKnob.SetSize( 27, 27 );
   centsKnob.SetSkin( "JP-106 Gray" );
   ...
   textLabel1.SetBkColor( new Color( 64, 128, 112, 255 ) );
   ...
   textLabel19 = new VoltageLabel( "textLabel19", "textLabel19", this, "TIMBRE" );
   AddComponent( textLabel19 );
   textLabel19.SetWantsMouseNotifications( false );
   textLabel19.SetPosition( 5, 190 );
   textLabel19.SetSize( 86, 15 );
   ...
   textLabel19.SetBkColor( new Color( 64, 128, 112, 255 ) );
   ...
   textLabel24 = new VoltageLabel( "textLabel24", "textLabel24", this, "DCW MOD" );
   AddComponent( textLabel24 );
   textLabel24.SetWantsMouseNotifications( false );
   textLabel24.SetPosition( 96, 190 );
   textLabel24.SetSize( 86, 15 );
   ...
   textLabel24.SetBkColor( new Color( 64, 128, 112, 255 ) );
   ...
   textLabel26 = new VoltageLabel( "textLabel26", "textLabel26", this, "NICENESS" );
   AddComponent( textLabel26 );
   textLabel26.SetWantsMouseNotifications( false );
   textLabel26.SetPosition( 5, 270 );
   textLabel26.SetSize( 86, 15 );
   ...
   textLabel26.SetBkColor( new Color( 64, 128, 112, 255 ) );
   ...
   textLabel2 = new VoltageLabel( "textLabel2", "textLabel2", this, "PHANTASMATIC" );
   ...
   textLabel3.SetBkColor( new Color( 64, 128, 112, 255 ) );
   ...
   textLabel5.SetBkColor( new Color( 64, 128, 112, 255 ) );
   ...
   textLabel6.SetBkColor( new Color( 64, 128, 112, 255 ) );
   ...
   textLabel21 = new VoltageLabel( "textLabel21", "textLabel21", this, "DCW" );
   AddComponent( textLabel21 );
   textLabel21.SetWantsMouseNotifications( false );
   textLabel21.SetPosition( 53, 243 );
   textLabel21.SetSize( 44, 15 );
   ...
   textLabel21.SetFont( "Arial", 10, false, false );
   ...
   textLabel20 = new VoltageLabel( "textLabel20", "textLabel20", this, "SHAPE" );
   AddComponent( textLabel20 );
   textLabel20.SetWantsMouseNotifications( false );
   textLabel20.SetPosition( 9, 243 );
   textLabel20.SetSize( 44, 15 );
   ...
   textLabel20.SetFont( "Arial", 10, false, false );
   ...
   textLabel10.SetPosition( 97, 161 );
   ...
   textLabel27 = new VoltageLabel( "textLabel27", "textLabel27", this, "OFF" );
   AddComponent( textLabel27 );
   textLabel27.SetWantsMouseNotifications( false );
   textLabel27.SetPosition( 7, 299 );
   textLabel27.SetSize( 28, 15 );
   ...
   textLabel27.SetFont( "Arial", 10, false, false );
   ...
   textLabel11.SetPosition( 155, 161 );
   ...
   textLabel28 = new VoltageLabel( "textLabel28", "textLabel28", this, "ON" );
   AddComponent( textLabel28 );
   textLabel28.SetWantsMouseNotifications( false );
   textLabel28.SetPosition( 65, 299 );
   textLabel28.SetSize( 28, 16 );
   ...
   textLabel28.SetFont( "Arial", 10, false, false );
   ...
   textLabel12.SetPosition( 97, 145 );
   ...
   textLabel22 = new VoltageLabel( "textLabel22", "textLabel22", this, "MONO" );
   AddComponent( textLabel22 );
   textLabel22.SetWantsMouseNotifications( false );
   textLabel22.SetPosition( 97, 243 );
   textLabel22.SetSize( 28, 15 );
   ...
   textLabel22.SetFont( "Arial", 10, false, false );
   ...
   textLabel13.SetPosition( 155, 145 );
   ...
   textLabel23 = new VoltageLabel( "textLabel23", "textLabel23", this, "POLY" );
   AddComponent( textLabel23 );
   textLabel23.SetWantsMouseNotifications( false );
   textLabel23.SetPosition( 155, 243 );
   textLabel23.SetSize( 28, 15 );
   ...
   textLabel23.SetFont( "Arial", 10, false, false );
   ...
   textLabel14.SetPosition( 126, 116 );
   ...
   textLabel25 = new VoltageLabel( "textLabel25", "textLabel25", this, "AMT" );
   AddComponent( textLabel25 );
   textLabel25.SetWantsMouseNotifications( false );
   textLabel25.SetPosition( 126, 211 );
   textLabel25.SetSize( 28, 15 );
   ...
   textLabel25.SetFont( "Arial", 10, false, false );
   ...
   textLabel17.SetPosition( 100, 318 );
   ...
   textLabel18.SetPosition( 151, 318 );
   ...
   textLabel8.SetBkColor( new Color( 64, 128, 112, 255 ) );
   ...
   pitch64Toggle.SetPosition( 17, 125 );
   pitch64Toggle.SetSize( 21, 21 );
   pitch64Toggle.SetSkin( "Mini Green" );
   ...
   pitch8Toggle.SetPosition( 17, 146 );
   pitch8Toggle.SetSize( 21, 21 );
   pitch8Toggle.SetSkin( "Mini Green" );
   ...
   fmAmtKnob.SetPosition( 130, 133 );
   fmAmtKnob.SetSize( 22, 22 );
   fmAmtKnob.SetSkin( "JP-106 Gray" );
   ...
   fmTypeSwitch.SetPosition( 121, 161 );
   fmTypeSwitch.SetSize( 37, 15 );
   fmTypeSwitch.SetSkin( "Rocker Switch Plastic Black Hor" );

   oversamplingSwitch = new VoltageSwitch( "oversamplingSwitch", "Oversampling", this, 0 );
   AddComponent( oversamplingSwitch );
   oversamplingSwitch.SetWantsMouseNotifications( false );
   oversamplingSwitch.SetPosition( 32, 299 );
   oversamplingSwitch.SetSize( 37, 15 );
   oversamplingSwitch.SetSkin( "Rocker Switch Plastic Black Hor" );

   modeSwitch = new VoltageSwitch( "modeSwitch", "Mode", this, 0 );
   AddComponent( modeSwitch );
   modeSwitch.SetWantsMouseNotifications( false );
   modeSwitch.SetPosition( 5, 219 );
   modeSwitch.SetSize( 50, 16 );
   ...
   dcwKnob.SetPosition( 62, 214 );
   dcwKnob.SetSize( 27, 27 );
   dcwKnob.SetSkin( "JP-106 Gray" );
   ...
   dcwModAmountKnob.SetPosition( 129, 230 );
   dcwModAmountKnob.SetSize( 22, 22 );
   dcwModAmountKnob.SetSkin( "JP-106 Gray" );
...
public boolean Notify( VoltageComponent component, ModuleNotifications notification, double doubleValue, long longValue, int x, int y, Object object )
{
   ...
   switch( notification )
   {
      ...
      case Switch_Changed:   // doubleValue is the new switch value
      {
         ...
         if (component == oversamplingSwitch) soundEngine.setOversamplingEnabled(doubleValue > 0.0);
      }
      break;
...
private VoltageSwitch oversamplingSwitch;
