...
/**
 * Pitch control and frequency modulation for Phantasmatic oscillators.
 *
 * Handles V/Oct pitch tracking, octave/semitone/cent adjustments, and both
 * linear and exponential FM. Part of the high-precision Phantasmatic module.
 */
public class PitchControl {
    ...
    public double incrementModulation(double fm) {
        return isExp ? 0 : fm * linearFmAmt;
    }
