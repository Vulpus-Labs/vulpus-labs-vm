...
public Prismatic( long moduleID, VoltageObjects voltageObjects )
{
   ...
   canBeBypassed = false;
   SetSkin( "926c38e2544746fbbe84e038a878b442" );
}
...
void InitializeControls()
{
   ...
   nastinessSwitch.SetPosition( 25, 297 );
   nastinessSwitch.SetSize( 50, 16 );
   ...
   textLabel19.SetBkColor( new Color( 128, 64, 64, 255 ) );
   ...
   textLabel24.SetBkColor( new Color( 128, 64, 64, 255 ) );
   ...
   textLabel26 = new VoltageLabel( "textLabel26", "textLabel26", this, "NASTINESS" );
   ...
   textLabel26.SetBkColor( new Color( 128, 64, 64, 255 ) );
...
public boolean Notify( VoltageComponent component, ModuleNotifications notification, double doubleValue, long longValue, int x, int y, Object object )
{
   ...
   switch( notification )
   {
      ...
      case Switch_Changed:   // doubleValue is the new switch value
      {
         ...
         if (component == nastinessSwitch) soundEngine.setNastiness(3 - (int) doubleValue);
      }
      break;
