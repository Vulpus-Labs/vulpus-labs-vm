...
public class Ratios extends VoltageModule
//[user-inheritance]
//[/user-inheritance]
{

   public Ratios( long moduleID, VoltageObjects voltageObjects )
   {
      super( moduleID, voltageObjects, "Ratios", ModuleType.ModuleType_Utility, 1.0 );

      InitializeControls();


      canBeBypassed = false;
      SetSkin( "30bbdf1264214f6d9d38aa5740a72168" );
   }

void InitializeControls()
{

      textLabel1 = new VoltageLabel( "textLabel1", "textLabel1", this, "RATIOS" );
      AddComponent( textLabel1 );
      textLabel1.SetWantsMouseNotifications( false );
      textLabel1.SetPosition( 0, 0 );
      textLabel1.SetSize( 72, 15 );
      ...
      textLabel2.SetPosition( 10, 334 );
      textLabel2.SetSize( 52, 26 );
      ...
      in = new VoltageAudioJack( "in", "Input Jack", this, JackType.JackType_AudioInput );
      AddComponent( in );
      in.SetWantsMouseNotifications( false );
      in.SetPosition( 8, 42 );
      in.SetSize( 25, 25 );
      in.SetSkin( "Mini Jack 25px" );

      out = new VoltageAudioJack( "out", "Output Jack", this, JackType.JackType_AudioOutput );
      AddComponent( out );
      out.SetWantsMouseNotifications( false );
      out.SetPosition( 39, 42 );
      out.SetSize( 25, 25 );
      out.SetSkin( "Mini Jack 25px" );

      numerator = new VoltageKnob( "numerator", "Numerator", this, 1, 20, 1 );
      AddComponent( numerator );
      numerator.SetWantsMouseNotifications( false );
      numerator.SetPosition( 18, 130 );
      numerator.SetSize( 36, 36 );
      numerator.SetSkin( "Cosmo v2 Med" );
      numerator.SetRange( 1, 20, 1, false, 20 );
      numerator.SetKnobParams( 215, 145 );
      numerator.DisplayValueInPercent( false );
      numerator.SetKnobAdjustsRing( true );

      denominator = new VoltageKnob( "denominator", "Denominator", this, 1, 20, 1 );
      AddComponent( denominator );
      denominator.SetWantsMouseNotifications( false );
      denominator.SetPosition( 18, 230 );
      denominator.SetSize( 36, 36 );
      denominator.SetSkin( "Cosmo v2 Med" );
      denominator.SetRange( 1, 20, 1, false, 20 );
      denominator.SetKnobParams( 215, 145 );
      denominator.DisplayValueInPercent( false );
      denominator.SetKnobAdjustsRing( true );

      numeratorCounter = new VoltageDigitalCounter( "numeratorCounter", "Numerator Display", this, 2 );
      AddComponent( numeratorCounter );
      numeratorCounter.SetWantsMouseNotifications( false );
      numeratorCounter.SetPosition( 15, 90 );
      numeratorCounter.SetSize( 42, 33 );
      numeratorCounter.SetSkin( "Gray-Green" );
      numeratorCounter.SetJustificationFlags( VoltageDigitalCounter.Justification.Centered );

      denominatorCounter = new VoltageDigitalCounter( "denominatorCounter", "Denominator Display", this, 2 );
      AddComponent( denominatorCounter );
      denominatorCounter.SetWantsMouseNotifications( false );
      denominatorCounter.SetPosition( 15, 190 );
      denominatorCounter.SetSize( 42, 33 );
      denominatorCounter.SetSkin( "Gray-Green" );
      denominatorCounter.SetJustificationFlags( VoltageDigitalCounter.Justification.Centered );
      ...
      textLabel3.SetPosition( 3, 24 );
      textLabel3.SetSize( 32, 15 );
      ...
      textLabel3.SetBkColor( new Color( 133, 21, 21, 255 ) );
      ...
      textLabel4.SetPosition( 37, 24 );
      textLabel4.SetSize( 32, 15 );
      ...
      textLabel4.SetBkColor( new Color( 133, 21, 21, 255 ) );
      ...
      textLabel5 = new VoltageLabel( "textLabel5", "textLabel5", this, "NUMERATOR" );
      AddComponent( textLabel5 );
      textLabel5.SetWantsMouseNotifications( false );
      textLabel5.SetPosition( 0, 72 );
      ...
      textLabel5.SetBkColor( new Color( 133, 21, 21, 255 ) );
      ...
      textLabel6 = new VoltageLabel( "textLabel6", "textLabel6", this, "DENOMINATOR" );
      AddComponent( textLabel6 );
      textLabel6.SetWantsMouseNotifications( false );
      textLabel6.SetPosition( 0, 172 );
      ...
      textLabel6.SetBkColor( new Color( 133, 21, 21, 255 ) );
      ...
      modeSwitch = new VoltageSwitch( "modeSwitch", "Mode Switch", this, 0 );
      AddComponent( modeSwitch );
      modeSwitch.SetWantsMouseNotifications( false );
      modeSwitch.SetPosition( 18, 292 );
      modeSwitch.SetSize( 36, 14 );
      modeSwitch.SetSkin( "Rocker Switch Plastic Orange Hor" );

      textLabel7 = new VoltageLabel( "textLabel7", "textLabel7", this, "LIN" );
      AddComponent( textLabel7 );
      textLabel7.SetWantsMouseNotifications( false );
      textLabel7.SetPosition( 4, 292 );
      textLabel7.SetSize( 16, 15 );
      ...
      textLabel8 = new VoltageLabel( "textLabel8", "textLabel8", this, "EXP" );
      AddComponent( textLabel8 );
      textLabel8.SetWantsMouseNotifications( false );
      textLabel8.SetPosition( 53, 292 );
      textLabel8.SetSize( 16, 15 );
      ...
      switch( notification )
      {
         case Knob_Changed:   // doubleValue is the new VoltageKnob value
         {
            if (component == numerator) {
               numeratorValue = (int) doubleValue;
               log2NumeratorValue = Math.log(doubleValue) * INVERSE_LOGE_2;
               
               linearScale = numeratorValue / (double) denominatorValue;
               exponentialScale = log2NumeratorValue - log2DenominatorValue;
               
               numeratorCounter.SetValue(doubleValue);
            }
            
            if (component == denominator) {
               denominatorValue = (int) doubleValue;
               log2DenominatorValue = Math.log(doubleValue) * INVERSE_LOGE_2;
               
               linearScale = numeratorValue / (double) denominatorValue;
               exponentialScale = log2NumeratorValue - log2DenominatorValue;
               
               denominatorCounter.SetValue(doubleValue);
            }
         }
         break;
   ...
   public void ProcessSample()
   {
      ...
      var input = in.GetValue();
      var output = isExp
         ? input + exponentialScale
         : input * linearScale;
      out.SetValue(output);
   ...
   public String GetTooltipText( VoltageComponent component )
   {
      ...
      if (component == modeSwitch) {
         return isExp ? "Exponential" : "Linear";
      }
   ...
   private VoltageDigitalCounter denominatorCounter;
   private VoltageDigitalCounter numeratorCounter;
   private VoltageKnob denominator;
   private VoltageKnob numerator;
...
private double log2NumeratorValue;
private double log2DenominatorValue;
private double exponentialScale;
private boolean isExp;

private static final double INVERSE_LOGE_2 = 1.0 / Math.log(2.0);
