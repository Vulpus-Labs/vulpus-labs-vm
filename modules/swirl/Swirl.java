...
public class Swirl extends VoltageModule
//[user-inheritance]
//[/user-inheritance]
{

   public Swirl( long moduleID, VoltageObjects voltageObjects )
   {
      super( moduleID, voltageObjects, "Swirl", ModuleType.ModuleType_PolyphonicUtilities, 3.6 );

      InitializeControls();


      canBeBypassed = false;
      SetSkin( "fdf7a59706e0417289e75774662beb14" );
   }

void InitializeControls()
{

      particleDisplay = new VoltageCanvas( "particleDisplay", "Particle Display", this, 200, 200 );
      AddComponent( particleDisplay );
      particleDisplay.SetWantsMouseNotifications( false );
      particleDisplay.SetPosition( 46, 24 );
      particleDisplay.SetSize( 200, 200 );
      ...
      polyOutputX.SetPosition( 162, 316 );
      ...
      polyOutputY.SetPosition( 218, 316 );
      ...
      interpolationLengthKnob.SetPosition( 107, 241 );
      ...
      interpolationLengthRange.SetPosition( 127, 236 );
      interpolationLengthRange.SetSize( 35, 35 );
      ...
      textLabel2 = new VoltageLabel( "textLabel2", "textLabel2", this, "SWIRL" );
      AddComponent( textLabel2 );
      textLabel2.SetWantsMouseNotifications( false );
      textLabel2.SetPosition( 0, 0 );
      textLabel2.SetSize( 259, 19 );
      ...
      triggerDriftInput.SetPosition( 60, 241 );
      ...
      textLabel5.SetPosition( 13, 269 );
      textLabel5.SetSize( 38, 20 );
      ...
      startDriftButton.SetPosition( 21, 243 );
      ...
      autoRetrigToggle.SetPosition( 165, 243 );
      ...
      textLabel10.SetPosition( 49, 269 );
      textLabel10.SetSize( 45, 20 );
      ...
      textLabel11.SetPosition( 95, 269 );
      textLabel11.SetSize( 45, 20 );
      ...
      textLabel12.SetPosition( 151, 269 );
      textLabel12.SetSize( 45, 20 );
      ...
      textLabel13.SetPosition( 199, 269 );
      textLabel13.SetSize( 45, 20 );
      ...
      driftLengthDesyncToggle.SetPosition( 213, 243 );
      ...
      textLabel14.SetPosition( 152, 298 );
      ...
      textLabel15.SetPosition( 208, 298 );
      ...
      textLabel16.SetPosition( 180, 298 );
      textLabel16.SetSize( 45, 20 );
      ...
      dcCorrectionSwitch.SetPosition( 190, 315 );
      dcCorrectionSwitch.SetSize( 25, 13 );
      dcCorrectionSwitch.SetSkin( "2-State Slide Horizontal" );
   ...
   public void Initialize()
   {
      ...
      var logoBytes = GetBinaryResource("logo_green.png");
      
      SwirlView view = new Graphics2dSwirlView(
         logoBytes,
         model,
         activeSize,
         particleDisplay.GetBitmapWidth(),
         particleDisplay.GetBitmapHeight());
   ...
   public boolean Notify( VoltageComponent component, ModuleNotifications notification, double doubleValue, long longValue, int x, int y, Object object )
   {
      ...
      switch( notification )
      {
         ...
         {
            controller.redraw(particleDisplay.GetGraphics());
         }
         break;
   ...
   private VoltageCanvas particleDisplay;
